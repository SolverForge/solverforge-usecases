...
* **release:** target SolverForge 0.19.4.
...
* **lessons:** target SolverForge 0.19.0 a8e491a
...
* **metadata:** align generated scalar-variable metadata with the current SolverForge UI schema.
