...
/// Training assignment solved over the training day variable.
#[planning_entity]
...
impl TrainingAssignment {
    pub fn new(id: impl Into<String>, requirement_id: String, vessel_id: String, inspection_id: String, baseline_day: i32) -> Self {
        Self {
            id: id.into(),
            requirement_id,
            vessel_id,
...
mod tests {
    ...
    #[test]
    fn test_training_assignment_construction() {
        let entity = TrainingAssignment::new("test-id", "test".to_string(), "test".to_string(), "test".to_string(), Default::default());
        assert_eq!(entity.id, "test-id");
        let _ = &entity.requirement_id;
        let _ = &entity.vessel_id;
        let _ = &entity.inspection_id;
